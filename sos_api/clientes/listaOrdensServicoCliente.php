<?php
    ...
    $query = "SELECT ordem_servico.id, ordem_servico.id_cliente, ordem_servico.obs, ordem_servico.problema_relatado, ordem_servico.problema_diagnosticado,
    ...
    clientes.nome, clientes.telefone, clientes.celular, clientes.whatsapp, equipamentos.id as id_equipamento, equipamentos.nome as equipamento, 
    equipamentos.descricao, categoria_equipamentos.categoria, funcionarios.id as id_atendente, funcionarios.nome as atendente,
    CASE WHEN clientes.cnpj != null THEN 'Pessoa Juridica' ELSE 'Pessoa Física' END as tipo_cliente FROM ordem_servico
    inner join clientes
    ...
    WHERE ordem_servico.id_cliente = :id";
